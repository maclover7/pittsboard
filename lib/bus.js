...
const stopGroupsLists = {
  ...
  'dith': [
    { name: 'Craig @ Centre DT', stops: [ { resolver: 'PA', id: '2633' } ] },
    { name: 'Craig @ Centre EE', stops: [ { resolver: 'PA', id: '2573' } ] },
    { name: 'Fifth @ Bigelow DT', stops: [ { resolver: 'PA', id: '34' } ] },
    { name: 'Fifth @ Bigelow EE', stops: [ { resolver: 'PA', id: '2567' } ] }
  ],
};
